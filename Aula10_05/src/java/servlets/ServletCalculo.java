 ...
 * @author dreis
 */
@WebServlet(name = "ServletCalculo", urlPatterns = {"/Calculadora"})
public class ServletCalculo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("Valor 1: <input type='text' name='valor1'>&nbsp;");
            ...
            if (request.getParameter("valor1") != null &&
                ...
                Calculo objCalculo = new Calculo(v1, v2);
                ...
                switch(operacao){
                    ...
                    case "x": resultado = objCalculo.multiplicar(); break;
