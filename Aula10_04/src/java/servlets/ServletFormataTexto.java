 ...
 * @author dreis
 */
@WebServlet(name = "ServletFormataTexto", urlPatterns = {"/FormataTexto"})
public class ServletFormataTexto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Formata texto</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Formata texto</h1>");
            
            out.println("<form action='' method=''>");
            out.println("Nome: <input type='text' name='texto'><br>");
            out.println("<br><input type='submit' value='Formatar texto'>");
            out.println("</form>");
    ...
    private String retornarMaiusculo (String texto){
        return texto.toUpperCase();
    }

    private String retornarMinusculo (String texto){
