            ...
            public void actionPerformed(ActionEvent e) {
                if (cboAplicacao.getSelectedIndex() > 0 &&
                    ...
                    txtPrazo.getText().length() > 0){
                        ...
                        float valorFinal = objAplicacao.getValorFinal();
